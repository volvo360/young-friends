...
$config['upload_dir'] = "/".$_SESSION['folder']."source/";
$config['current_path'] = "../../".$_SESSION['folder']."source/";

$config['thumbs_upload_dir'] = "/".$_SESSION['folder']."thumbs/";
$config['thumbs_base_path'] = "../../".$_SESSION['folder']."thumbs/";

if ($_SERVER['SERVER_NAME'] === "server01")
{
	$config['base_url'] .= "/flexshare/yf";
}
