...
if (basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME']))
{
    ...
    if ($replaceTable[$_POST['replaceTable']] === PREFIX.'statutes')
    {
        deleteAjax_statutes();
    }
...
function deleteAjax_statutes()
{
    ...
    $sql = "DELETE FROM ".$table." WHERE tableKey = '".str_replace(array( "[", "]"), array('','') , mysqli_real_escape_string($link, $matches[0][0]))."'";
